...
\ifdefined\thisbookhasacover
	...
	\ifdefined\thisisnotfantasybattles
        \tikz[remember picture,overlay] \node[inner sep=0pt, below=3cm] at (current page.north) {\includegraphics[width=122mm]{$RSC_PATH$/Layout/pics/BRAND9AgeLogotypeGOLD_noFB_$LANGUAGE$.png}};
    \else
		\tikz[remember picture,overlay] \node[inner sep=0pt, below=3cm] at (current page.north) {\includegraphics[width=122mm]{$RSC_PATH$/Layout/pics/BRAND9AgeLogotypeGOLD_$LANGUAGE$.png}};
    \fi
...
\ifdefined\languageisfrench
    \includegraphics[height=3.3cm]{$RSC_PATH$/Layout/pics/BRAND9AgeLogotype_$LANGUAGE$.pdf}%
\else
    \includegraphics[height=3cm]{$RSC_PATH$/Layout/pics/BRAND9AgeLogotype_$LANGUAGE$.pdf}%
\fi
