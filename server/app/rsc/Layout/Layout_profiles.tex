...
\newcommand{\setoptionitem}[1]{%
	\saveexpandmode%
	\noexpandarg%
	\StrCut{#1}{=}\optiontext\optionvalue%
...
\newcommand{\addsortedexploption}[1]{%
	...
	\cleanstringforsorting{\exploptions@name}% output is saved to \textwithoutformatting		
	\cleannumberforsorting{\exploptions@cost}% output is saved to \costtwithoutformatting
...
\newcommand{\modelrulesdef}[1]{%
	\begin{innerframenopts}[\labels@modelrulesdef]%
		\expandafter\unitrulelist\expandafter{#1}
	\end{innerframenopts}%	
}%
