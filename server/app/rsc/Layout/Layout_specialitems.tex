...
\newcommand{\itementry}[1]{%
	...
	\cleanstringforsorting{\item@name}% output is saved to \textwithoutformatting		
	\def\DTLentrycommand{\DTLnewdbentry{sortedpricelist}{sortlabel}}%
	\expandafter\DTLentrycommand\expandafter{\textwithoutformatting}%
	\cleannumberforsorting{\item@cost}% output is saved to \costtwithoutformatting
	...
	\def\temphypertag{}%
	\ConvertNameMacroToStr{\item@name}{\temphypertag} % remove first the \ to the left and then the {} to the right
...
\newcommand{\sortedpricelistitem}[3]{% deprecated
	...
	\def\DTLentrycommand{\DTLnewdbentry{sortedpricelist}{sortlabel}}%
	\expandafter\DTLentrycommand\expandafter{\textwithoutformatting}%
	\cleannumberforsorting{#2}% output is saved to \costtwithoutformatting
	\def\DTLentrycommand{\DTLnewdbentry{sortedpricelist}{costsortlabel}}%
	\expandafter\DTLentrycommand\expandafter{\costwithoutformatting}%
}
